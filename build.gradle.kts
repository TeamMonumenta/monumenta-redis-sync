...
monumenta {
	...
	paper(
		"com.playmonumenta.redissync.MonumentaRedisSync", BukkitPluginDescription.PluginLoadOrder.POSTWORLD, "1.19",
		depends = listOf("CommandAPI"),
		softDepends = listOf("MonumentaNetworkRelay")
	)

	waterfall("com.playmonumenta.redissync.MonumentaRedisSyncBungee", "1.19")
